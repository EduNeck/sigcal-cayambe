<template>
  ...
  <v-container  class="pdf-wrapper" fluid>
    <div id="certificado" class="a4-container">
        ...
        <v-card-text class="block-text">
          <v-row no-gutters>
            <v-col cols="12">
              ...
              <p class="styled-text"><strong>PARA: DIRECTOR FINACIERO DEL GOBIERNO AUTONOMO DESCENTRALIZADO DEL CANTON CAYAMBE COMINICO A USTED QUE ANTE EL SUSCRITO NOTARIO. VA A PROTOCOLZARSE UN CONTRATO DE</strong></p>              
            </v-col>
            <v-col cols="12" mt-1>              
      ...
      <v-card>
        <v-card-title class="block-title fondo-sub">
          CARACTERISTICS DE ESCRITURAS ACTUALES
        </v-card-title>
        <v-card-text class="block-text">
          <v-row no-gutters>
            <v-col cols="12">              
