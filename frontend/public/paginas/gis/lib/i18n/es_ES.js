...
Heron.i18n.dict = {
	...
	'Legend': 'Leyenda',
	'Feature Info': 'Informacion del elemento ',
	...
	'Feature information': 'Informacion del elemento',
	'No Information found': 'No se ha encontrado informacion',
	'Layer not added': 'Capa no agregada',
	'Attribute': 'Atributos',
	'Value': 'Valor',
	...
	'Places': 'Lugares',
	'Unknown': 'Desconocido',
	'Feature Info unavailable':'Informacion del elemento no disponible',
	'Pan': 'Mover mapa',
	'Leg' : 'Etapa',
	...
	'< Search': '< Busqueda',
	'Search': 'Busqueda',
	'Search Nominatim': 'Buqueda (OSM) por nombre y direccion',
	'Search OpenLS' : 'Buscar con servicio OpenLS',
	'Search PDOK': 'Type (parts of) Dutch national address',
	'Searching...': 'Buscando...',
	'Search Completed: ': 'Buqueda completada: ',
	'services':'servicios',
	'service':'servicio',
	'Type Nominatim': 'Escribe un lugar o direccion...',
	'Overlays': 'Overlays',
	...
	'No features available or non-grid display chosen' : 'No hay objetos que mostrar o no se eligio la vista de grilla',
	'Choose an Export Format' : 'Elija un formato de exportacion',
	'Print Visible Map Area Directly' : 'Imprimir area visible del mapa',
	'Direct Print Demo' : 'Demo de Impresion Directa',
	'This is a simple map directly printed.' : 'Este es un mapa impreso directamente.',
	'Print Dialog Popup with Preview Map' : 'Dialogo de impresion on previsualizacióon',
	'Print Preview' : 'Previsualizacion de impresion',
	'Print Preview Demo' : 'Demo: Previsualizacion de impresion',
	'Error getting Print options from server: ' : 'Error en opciones de impresion del servidor: ',
	'Error from Print server: ' : 'Error del servidor de impresi&oacute;n: ',
	...
	'Tools': 'Herramientas',
	'Removing': 'Quitando',
	'Are you sure you want to remove the layer from your list of layers?': 'Esta seguro que desea quitar la capa de su lista?',
	'You are not allowed to remove the baselayer from your list of layers!': 'No esta permitido quitar capas base de la lista!',
    ...
    'Choose a geometry tool and draw with it to search for objects that touch it.': 'Elija una herramienta y dibuje para buscar objetos que toquen la geometria.',
    'Seconds': 'Segundos',
	'Working on it...':'Trabajando...',
	'Still searching, please be patient...':'Todavia buscando, por favor tenga paciencia...',
	'Still searching, have you selected an area with too many objects?':'En progreso, puede que haya seleccionado un aea con demasiados objetos?',
	'as': 'como',
    ...
    'with': 'con',
    'Too many geometries for spatial filter: ': 'Demasiadas geometrias para el filtro espacial: ',
    ...
    'Draw circle (click and drag)': 'Dibujar circulo (click y arrastre)',
    ...
    'Select a search...': 'Seleccione una busqueda...',
    'Clear': 'Limpiar',
    ...
    'Error: No \'BookmarksPanel\' found.': 'Error: No se encontro \'Panel de marcadores\'.',
    ...
    'Feature Info unavailable (you may need to make some layers visible)': 'No es posible dar informacion (puede que tenga que encender alguna capa)',
	...
	'Cancel current search':'Cancelar busqueda actual',
	...
	'Select a source Layer and then draw to select objects from that layer. <br/>Then select a target Layer to search in using the geometries of the selected objects.':'Dibuje sobre una capa para seleccionar. <br/>Luego elija una capa para buscar usando la geometria de los objetos seleccionados.',
	'Choose a Layer':'Elija una capa',
	'Select a target layer to search using the geometries of the selected objects':'Elija una capa para buscar usando la geometria de los objetos seleccionados',
	...
	'Upload features from local file':'Cargar geometris desde archivo',
	'oleUploadFeatureReplace':'Reemplazar geometris en la capa',
	'Get Layer information':'Mostrar informacion',
	'Change Layer opacity':'Cambiar opacidad',
	'Edit Layer Style':'Editar estilos',
    'No query layers found': 'No se encontraron layers de busqueda',
    'Edit Layer Style': 'Editar estilo de la capa',
    'Zoom to Layer Extent': 'Zoom a la extension de la capa',
    'Get Layer information': 'Informacio de la capa',
    'Change Layer opacity': 'Cambiar opacidad',
    'Select a drawing tool and draw to search immediately': 'Seleccione una herramienta y dibuje para buscar',
    'Search in': 'Buscar en',
    'Search Canceled': 'Buqueda cancelada',
    'Help and info for this example': 'Ayuda para este ejemplo',

	//0.77
	'Build your own searches':'Arme su propia busqueda',
    ...
    'Show next record': 'Mostrar proimo registro',
    'Show previous record': 'Mostrar registro anterior',
	'Feature tooltips' : 'Descripcio emergente',
	'FeatureTooltip' : 'DescripcionEmergente',
	'Upload features from local file' : 'Cargar geometris desde archivo',
	'My Upload' : 'Capa Agregada',
	'Anything is allowed here' : 'Todo esta permitido aqu',
    ...
    'Change feature styles': 'Cambiar el estilo de las geometras',
	...
	'Change Opacity':'Cambiar transparencia',

	'Type of Search': 'Tipo de busqueda',
	'Select the spatial operator (optional) and use the Search button to start your search.':'Seleccione el operador espacial (opcional) y utilizar el boton Buscar para iniciar la busqueda.',
	'Actions':'Accion',
	'objects selected from':'objeto seleccionado de',
	'Multiple Searches': 'Busquedas multiples',
	'Change Layer Opacity':'Cambiar la transparencia de la capa'
};
